...
export function LineupPlayerCardCloseBtn({
  ...
  return (
    <div
      className="absolute right-4 top-4 w-6 max-w-fit cursor-pointer items-center gap-1.5 overflow-hidden transition-all hover:w-full 3xl:right-3 3xl:top-3 3xl:gap-2"
      onClick={onClose}
    >
