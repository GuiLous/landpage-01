      ...
      <PrimitiveTooltip.Root delayDuration={delay}>
        ...
        <PrimitiveTooltip.Portal>
          <PrimitiveTooltip.Content
            sideOffset={0}
            className="z-50 inline-flex w-full items-center bg-gray-1000 px-2 py-1.5 radix-side-bottom:animate-slide-up-fade radix-side-left:animate-slide-right-fade radix-side-right:animate-slide-left-fade radix-side-top:animate-slide-down-fade"
            side={side}
          >
